...
import 'alerter_notifications.dart';
import 'macos_alarm_manager.dart' show timeout;

final _logger = Logger('MacOSNotificationManager');
...
Future<int> _notify(ActionSpecification actionSpec,
  ...
  await notify(id, actionSpec.experiment.title, notificationHolder.message);
  return id;
}
