...
class TestResult {
  ...
  TestResult(this.groupName, this.periodStart, this.nextPeriodStart, this.alarmStart, this.alarmEnd,
...
final m = {
  'Experiment 1': {
    dt1: TestResult('Experiment 1', DateTime(2001, 1, 1), DateTime(2001, 1, 2), 9, 17, 0, 0, 5, 59),
    dt2: TestResult('Experiment 1', DateTime(2005, 9, 15), DateTime(2005, 9, 16), 9, 17, 0, 0, 5, 59),
    dt3: TestResult('Experiment 1', DateTime(2012, 8, 25), DateTime(2012, 8, 26), 9, 17, 0, 0, 5, 59),
  },
  'Experiment 2': {
    dt1: TestResult('Experiment 2', DateTime(2001, 1, 1), DateTime(2001, 1, 8), 6, 14, 7, 7, 11, 118),
    dt2: TestResult('Experiment 2', DateTime(2005, 9, 12), DateTime(2005, 9, 19), 6, 14, 7, 7, 11, 118),
    dt3: TestResult('Experiment 2', DateTime(2012, 8, 20), DateTime(2012, 8, 27), 6, 14, 7, 7, 11, 118),
  },
  'Experiment 3': {
    dt1: TestResult('Experiment 3', DateTime(2001, 1, 1), DateTime(2001, 2, 1), 13, 23, 31, 28, 45, 15),
    dt2: TestResult('Experiment 3', DateTime(2005, 9, 1), DateTime(2005, 10, 1), 13, 23, 30, 31, 45, 15),
    dt3: TestResult('Experiment 3', DateTime(2012, 8, 1), DateTime(2012, 9, 1), 13, 23, 31, 30, 45, 15),
  },
  'Experiment 4': {
    dt1: TestResult('Experiment 4', DateTime(2001, 1, 1), DateTime(2001, 1, 2), 11, 13, 0, 0, 1, 10, false),
    dt2: TestResult('Experiment 4', DateTime(2005, 9, 15), DateTime(2005, 9, 16), 11, 13, 0, 0, 1, 10, false),
    dt3: TestResult('Experiment 4', DateTime(2012, 8, 27), DateTime(2012, 8, 28), 11, 13, 0, 0, 1, 10, false),
  },
  'Experiment 5': {
    dt1: TestResult('Experiment 5', DateTime(2001, 1, 1), DateTime(2001, 1, 8), 0, 5, 7, 7, 3, 400, false),
    dt2: TestResult('Experiment 5', DateTime(2005, 9, 12), DateTime(2005, 9, 19), 0, 5, 7, 7, 3, 400, false),
    dt3: TestResult('Experiment 5', DateTime(2012, 8, 20), DateTime(2012, 8, 27), 0, 5, 7, 7, 3, 400, false),
  },
  'Experiment 6': {
    dt1: TestResult('Experiment 6', DateTime(2001, 1, 1), DateTime(2001, 2, 1), 16, 22, 31, 28, 16, 200, false),
    dt2: TestResult('Experiment 6', DateTime(2005, 9, 1), DateTime(2005, 10, 3), 16, 22, 30, 31, 16, 200, false),
    dt3: TestResult('Experiment 6', DateTime(2012, 8, 1), DateTime(2012, 9, 3), 16, 22, 31, 30, 16, 200, false),
  },
};

void main() async {
  final experiments = _loadExperiments('test/data/esm_schedule_test_data.json');

  for (var e in experiments) {
    await ESMSignalStorage().deleteAllSignals();

    for (var dt in _testDateTimes) {
      test('${e.title}: ${dt.toIso8601String()}', () async {
