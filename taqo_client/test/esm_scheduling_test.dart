...
class ESMTestResult {
  ...
  bool _verifyBuffer(Iterable<Map> period) {
    final alarms = period
        .map((r) => DateTime.parse(r['alarmTime']))
  ...
  bool verify(List<Map> result) {
    final period = result.where((m) =>
        DateTime.parse(m['date']) == periodStart &&
        m['groupName'] == groupName);
    final pStart = periodStart.add(Duration(hours: alarmStart));
    final pEnd = periodStart
        .add(Duration(days: periodLength))
        .add(Duration(hours: alarmEnd));

    final nextPeriod = result.where((m) =>
        DateTime.parse(m['date']) == nextPeriodStart &&
        m['groupName'] == groupName);
    final pNextStart = nextPeriodStart.add(Duration(hours: alarmStart));
    final pNextEnd = nextPeriodStart
        .add(Duration(days: nextPeriodLength))
        .add(Duration(hours: alarmEnd));
...
final m = {
  'Experiment 1': {
    dt1: ESMTestResult('Experiment 1', DateTime(2001, 1, 1),
        DateTime(2001, 1, 2), 9, 17, 0, 0, 5, 59),
    dt2: ESMTestResult('Experiment 1', DateTime(2005, 9, 15),
        DateTime(2005, 9, 16), 9, 17, 0, 0, 5, 59),
    dt3: ESMTestResult('Experiment 1', DateTime(2012, 8, 25),
        DateTime(2012, 8, 26), 9, 17, 0, 0, 5, 59),
  },
  'Experiment 2': {
    dt1: ESMTestResult('Experiment 2', DateTime(2000, 12, 31),
        DateTime(2001, 1, 7), 6, 14, 7, 7, 11, 118),
    dt2: ESMTestResult('Experiment 2', DateTime(2005, 9, 11),
        DateTime(2005, 9, 18), 6, 14, 7, 7, 11, 118),
    dt3: ESMTestResult('Experiment 2', DateTime(2012, 8, 19),
        DateTime(2012, 8, 26), 6, 14, 7, 7, 11, 118),
  },
  'Experiment 3': {
    dt1: ESMTestResult('Experiment 3', DateTime(2001, 1, 1),
        DateTime(2001, 2, 1), 13, 23, 31, 28, 45, 15),
    dt2: ESMTestResult('Experiment 3', DateTime(2005, 9, 1),
        DateTime(2005, 10, 1), 13, 23, 30, 31, 45, 15),
    dt3: ESMTestResult('Experiment 3', DateTime(2012, 8, 1),
        DateTime(2012, 9, 1), 13, 23, 31, 30, 45, 15),
  },
  'Experiment 4': {
    dt1: ESMTestResult('Experiment 4', DateTime(2001, 1, 1),
        DateTime(2001, 1, 2), 11, 13, 0, 0, 1, 10, false),
    dt2: ESMTestResult('Experiment 4', DateTime(2005, 9, 15),
        DateTime(2005, 9, 16), 11, 13, 0, 0, 1, 10, false),
    dt3: ESMTestResult('Experiment 4', DateTime(2012, 8, 27),
        DateTime(2012, 8, 28), 11, 13, 0, 0, 1, 10, false),
  },
  'Experiment 5': {
    dt1: ESMTestResult('Experiment 5', DateTime(2001, 1, 1),
        DateTime(2001, 1, 8), 0, 5, 7, 7, 3, 400, false),
    dt2: ESMTestResult('Experiment 5', DateTime(2005, 9, 12),
        DateTime(2005, 9, 19), 0, 5, 7, 7, 3, 400, false),
    dt3: ESMTestResult('Experiment 5', DateTime(2012, 8, 20),
        DateTime(2012, 8, 27), 0, 5, 7, 7, 3, 400, false),
  },
  'Experiment 6': {
    dt1: ESMTestResult('Experiment 6', DateTime(2001, 1, 1),
        DateTime(2001, 2, 1), 16, 22, 31, 28, 16, 200, false),
...
void main() async {
  ...
  final esmExperiments =
      _loadExperiments('test/data/esm_schedule_test_data.json');
