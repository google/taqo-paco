...
class InterruptCue extends Validatable {
  ...
  static const CUE_EVENTS = [
    ...
    MUSIC_STARTED,
    MUSIC_STOPPED,
    PHONE_INCOMING_CALL_STARTED,
    PHONE_INCOMING_CALL_ENDED,
    PHONE_OUTGOING_CALL_STARTED,
    PHONE_OUTGOING_CALL_ENDED,
    PHONE_MISSED_CALL,
    PHONE_CALL_STARTED,
    PHONE_CALL_ENDED,
    PACO_EXPERIMENT_JOINED_EVENT,
    PACO_EXPERIMENT_ENDED_EVENT,
    PACO_EXPERIMENT_RESPONSE_RECEIVED_EVENT,
    APP_REMOVED,
    APP_ADDED,
    PERMISSION_CHANGED,
    ...
    NOTIFICATION_TRAY_CLEAR_ALL,
    NOTIFICATION_TRAY_SWIPE_DISMISS,
    NOTIFICATION_TRAY_CANCELLED,
    NOTIFICATION_CLICKED
  ];

  static const CUE_EVENT_NAMES = [
    "HANGUP (deprecated)",
    "USER_PRESENT",
    "Paco Action",
    "App Started",
  ...
  factory InterruptCue.fromJson(Map<String, dynamic> json) =>
      _$InterruptCueFromJson(json);
...
//    System.out.println("VALIDATING CUE");
    ...
    if (cueCode != null &&
        (cueCode == PACO_ACTION_EVENT || cueCode == APP_USAGE)) {
      validator.isNonEmptyString(
          cueSource,
          "cuesource must be valid for cuecode: " +
              CUE_EVENT_NAMES[cueCode - 1]);
    }
  }
}
